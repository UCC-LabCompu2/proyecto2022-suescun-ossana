...
Esta pagina corresponde a un juego basado en pilotear un cohete espacial e ir esquivando distintos obstaculos que van apareciendo en el camino y llegar lo mas lejos posible. 
...
##tecnologias usadas
las tecnologias que utilizamos para el desarollo del proyecto son:
*HTML5
*CCS3
*javaScript
